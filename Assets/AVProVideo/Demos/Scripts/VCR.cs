...
namespace RenderHeads.Media.AVProVideo.Demos
{
	...
	public class VCR : MonoBehaviour 
	{
		...
		public Sprite PlayControlSprite;
		public Sprite PauseControlSprite;
...
//			SetButtonEnabled( "PauseButton", _mediaPlayer.m_AutoStart );
		...
		public void OnPlayButton()
		{
			if(PlayingPlayer.Control.IsPlaying())
			{
				...
				playPauseButton.image.sprite = PlayControlSprite;
			...
			else
			{
				...
				playPauseButton.image.sprite = PauseControlSprite;
			}
		}
